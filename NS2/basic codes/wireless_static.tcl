...
#log-file
set tracefile [open wireless_static_802_11.tr w]
$ns trace-all $tracefile

#animation file
set namfile [open wireless_static_802_11.nam w]
$ns namtrace-all-wireless $namfile $x_dim $y_dim

#report will be generated using this
set topofile [open wireless_static_802_11.txt w]
...
proc finish {} {
	...
	close $namfile
	close $topofile
    exec nam wireless_static_802_11.nam &
    exit 0
}
